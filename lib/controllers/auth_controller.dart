...
import 'package:tiktok_see/models/user.dart' as model;
  ...
  void registerUser(
    ...
    try {
      if (username.isNotEmpty &&
          ...
          password.isNotEmpty &&
          image != null) {
        // save  out user to our and firebase
       ...
       await firestore.collection('users').doc(cred.user!.uid).set(user.toJson());
        ...
        Get.snackbar('Error Creating Accound ', 'Please enter all the fields');
      }
    } catch (e) {
      Get.snackbar('Error Creating Accound ', toString());
    }
  }
